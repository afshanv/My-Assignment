...
favoriteTransportation.forEach(function (transportation, index) {
...
guestList.forEach(function (guest, index) {
    console.log("Dear ".concat(guest, ", you are invited to join me for dinner. It would be an honor to have you at the table."));
});
//////Question:15//////
...
originalGuestList.forEach(function (guest, index) {
    console.log("Dear ".concat(guest, ", you are invited to join me for dinner. It would be an honor to have you at the table."));
});
...
var updatedGuestList = originalGuestList.map(function (guest) { return (guest === guestWhoCantMakeIt ? replacementGuest : guest); });
// Print the updated invitations
updatedGuestList.forEach(function (guest, index) {
    console.log("Dear ".concat(guest, ", you are invited to join me for dinner. It would be an honor to have you at the table."));
});
//Print the name of the guest who can't make it
console.log("".concat(guestWhoCantMakeIt, " regrets that they can't make it to dinner."));
///////Question:16///////
// Store the original guest list
var originalGuestList = ["Albert Einstein", "Ada Lovelace", "Nelson Mandela"];
// Print the original invitations
...
updatedGuestList.forEach(function (guest, index) {
    console.log("Dear ".concat(guest, ", you are still invited to join me for dinner. See you there!"));
});
...
if (username.length > 0) {
    for (var _a = 0, usernames_2 = usernames; _a < usernames_2.length; _a++) {
        var username_2 = usernames_2[_a];
        if (username_2.toLowerCase() === 'admin') {
            console.log("Hello admin, would you like to see a status report?");
        }
        else {
            console.log("Hello ".concat(username_2, ", thank you for logging in again."));
        }
    }
}
else {
